...
class Header extends Component {
	render() {
		let styles20 = { width: '20%' };
		let styles40 = { width: '40%' };
		let styles60 = { width: '60%' };
		let styles80 = { width: '80%' };
		    ...
		    <nav className="navbar navbar-static-top">
      		...
      		<div className="navbar-custom-menu">
		                ...
		                <ul className="menu">
		                  <li>
		                    <a href="#">
		                      ...
		                      <div className="progress xs">
		                        <div className="progress-bar progress-bar-aqua" style= {styles20} role="progressbar"
		                  ...
		                  <li>
		                    <a href="#">
		                      ...
		                      <div className="progress xs">
		                        <div className="progress-bar progress-bar-green" style={styles40} role="progressbar"
		                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
		                  ...
		                  <li>
		                    <a href="#">
		                      ...
		                      <div className="progress xs">
		                        <div className="progress-bar progress-bar-red" style={styles60} role="progressbar"
		                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
		                  ...
		                  <li>
		                    <a href="#">
		                      ...
		                      <div className="progress xs">
		                        <div className="progress-bar progress-bar-yellow" style={styles80} role="progressbar"
		                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
		          ...
		          <li className="dropdown user user-menu">
		            <a href="#" className="dropdown-toggle" data-toggle="dropdown">
		              <img src="img/user2-160x160.jpg" className="user-image" />
